...
AsgStmt : id ASSIGN expr SEMI  {
    ...
    //     | Field ASSIGN ALLOC LPAREN RPAREN SEMI  {
    //                                         if($1->type == TLookup("int") || $1->type == TLookup("str")) {
    //                                             yyerror("Cannot ALLOC to str or int variable\n");
    //                                             exit(1);
    //                                         }
    //                                         $$ = createTree(TLookup("void"), NULL,ASSIGN_NODE, NULL, NULL, $1, $3, NULL);
    //                                     }
    //    | ID ASSIGN ALLOC LPAREN RPAREN SEMI     {
    //                                         assignType($1, 0);
    //                                         if($1->type == TLookup("int") || $1->type == TLookup("str")) {
    //                                             yyerror("Cannot ALLOC to str or int variable\n");
    //                                             exit(1);
    ...
    //                                         assignType($1, 0);
    //                                         if($1->type == TLookup("int") || $1->type == TLookup("str")) {
    //                                             yyerror("Cannot assign NULL to str or int variable\n");
    //                                             exit(1);
    //                                         }
    //                                         $$ = createTree(TLookup("void"), NULL,ASSIGN_NODE, NULL, NULL, $1, $3, NULL);
    //                                     }
    //    | Field ASSIGN NILL SEMI           {
    //                                         if($1->type == TLookup("int") || $1->type == TLookup("str")) {
    //                                             yyerror("Cannot assign NULL to str or int variable\n");
    //                                             exit(1);
    //                                         }
