...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_kBEGIN = 13,                    /* kBEGIN  */
  YYSYMBOL_kEND = 14,                      /* kEND  */
...
static const char *const yytname[] =
{
  ...
  "MINUS", "MUL", "DIV", "LPAREN", "RPAREN", "ASSIGN", "SEMICOLON",
  "kBEGIN", "kEND", "WRITE", "READ", "$accept", "Program", "Slist", "Stmt",
...
{
      -8,     4,     6,    -1,   -15,     3,     8,     7,    16,   -15,
     -15,   -15,   -15,     0,     0,    30,   -15,    28,   -15,   -15,
     -15,     0,    31,    19,    32,   -15,    25,     0,     0,     0,
       0,   -15,   -15,   -15,    -6,    -6,   -15,   -15
};
...
{
       0,     0,     0,     0,     3,     0,     0,     0,     0,     6,
       7,     8,     1,     0,     0,     0,     2,     0,     5,    17,
      18,     0,    11,     0,     0,     4,     0,     0,     0,     0,
       0,    10,     9,    16,    12,    13,    14,    15
};

/* YYPGOTO[NTERM-NUM].  */
static const yytype_int8 yypgoto[] =
{
     -15,   -15,   -15,    34,   -15,   -15,   -15,   -14
};
...
{
      23,    29,    30,    19,    20,     1,    12,    26,     3,    21,
      13,     3,    14,    34,    35,    36,    37,    15,     4,     5,
       6,    16,     5,     6,    27,    28,    29,    30,    18,    31,
      27,    28,    29,    30,    24,    33,    27,    28,    29,    30,
      25,    17,    32
};

static const yytype_int8 yycheck[] =
{
      14,     7,     8,     3,     4,    13,     0,    21,     4,     9,
      11,     4,     9,    27,    28,    29,    30,     9,    14,    15,
      16,    14,    15,    16,     5,     6,     7,     8,    12,    10,
...
{
       0,    13,    18,     4,    14,    15,    16,    19,    20,    21,
      22,    23,     0,    11,     9,     9,    14,    20,    12,     3,
       4,     9,    24,    24,     4,    12,    24,     5,     6,     7,
       8,    10,    10,    10,    24,    24,    24,    24
};
...
#line 1221 "y.tab.c"
  ...
  case 9: /* InputStmt: READ LPAREN ID RPAREN  */
#line 50 "task2.y"
                           { yyval = makeReadNode(yyvsp[-1]); }
#line 1227 "y.tab.c"
    break;

  case 10: /* OutputStmt: WRITE LPAREN expr RPAREN  */
#line 53 "task2.y"
                             { yyval = makeWriteNode(yyvsp[-1]); }
#line 1233 "y.tab.c"
    break;

  case 11: /* AssgStmt: ID ASSIGN expr  */
#line 56 "task2.y"
